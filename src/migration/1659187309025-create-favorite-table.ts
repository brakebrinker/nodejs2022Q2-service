...
export class createFavoriteTable1659187309025 implements MigrationInterface {
  name = 'createFavoriteTable1659187309025';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "favorite" ("id" character(36) NOT NULL, "type" character varying(10) NOT NULL, CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorite_artists_artist" ("favoriteId" character(36) NOT NULL, "artistId" character(36) NOT NULL, CONSTRAINT "PK_9daf4f3eab7a3ee1831d06356af" PRIMARY KEY ("favoriteId", "artistId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "favorite_albums_album" ("favoriteId" character(36) NOT NULL, "albumId" character(36) NOT NULL, CONSTRAINT "PK_4247432ea32c9166fead9833826" PRIMARY KEY ("favoriteId", "albumId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "favorite_tracks_track" ("favoriteId" character(36) NOT NULL, "trackId" character(36) NOT NULL, CONSTRAINT "PK_a16bd1c831b4a8f6b310051b845" PRIMARY KEY ("favoriteId", "trackId"))`,
    );
    await queryRunner.query(
