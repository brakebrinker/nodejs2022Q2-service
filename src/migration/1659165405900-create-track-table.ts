...
export class createTrackTable1659165405900 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "track" ("id" character(36) NOT NULL, "name" character varying NOT NULL, "duration" integer NOT NULL, "artistId" character(36), "albumId" character(36), CONSTRAINT "PK_0631b9bcf521f8fab3a15f2c37e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
