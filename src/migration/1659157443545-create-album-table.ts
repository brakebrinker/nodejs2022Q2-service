...
export class createAlbumTable1659157443545 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "album" ("id" character(36) NOT NULL, "name" character varying NOT NULL, "year" integer NOT NULL, "artistId" character(36), CONSTRAINT "PK_58e0b4b8a31bb897e6959fe3206" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
